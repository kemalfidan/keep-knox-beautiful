...
// GET /api/volunteer/[id] will return a single volunteer profile that matches the volId
// POST /api/volunteer/[id] will take new form data and update basic account info

// @route   GET /api/Volunteer/[volId] - Returns a single Volunteer object for volunteer volId.
